...
void usage(char * argv[])
{
    ...
    #else
    cout << "Usage: " << argv[0] << " [OPTIONS] domainfile problemfile [externalSolver externalSolverInputs, if -x specified] [planfile, if -r specified] \n\n";
    #endif
    cout << "Options are: \n\n";
    cout << "\t" << "-citation" << "\t" << "Display citation to relevant conference paper (ICAPS 2010; ICAPS 2013);\n";
    cout << "\t" << "-w" << "\t\t" << "Lookahead heuristic;\n";
    cout << "\t" << "-x" << "\t\t" << "Use external solver;\n";
